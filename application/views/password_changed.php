	...
	<div id="pageContainer" class="flex-1 v-flex">
		<div class="whole-page flex-1">
			<div class="login-container v-flex">
				<a id="logo" href="<?= site_url() ?>" class="ml-auto mr-auto">
					<img src="<?= site_url() ?>frontend/images/logos/ponymanager.svg"/>
					<span>PonyManager</span>
				</a>
				<h4 class="password-reset"><b>La password è stata reimpostata con successo.</b><br/> Tra qualche secondo verrai reindirizzato alla pagina di login. Se non funziona, <a href="<?= site_url() ?>main/login">puoi clicare qui</a>.</h4>
			</div>
		</div>
	</div>
</body>
